...
var format_PipaDistribusi_14 = new ol.format.GeoJSON();
var features_PipaDistribusi_14 = format_PipaDistribusi_14.readFeatures(json_PipaDistribusi_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PipaDistribusi_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PipaDistribusi_14.addFeatures(features_PipaDistribusi_14);
var lyr_PipaDistribusi_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PipaDistribusi_14, 
                style: style_PipaDistribusi_14,
                popuplayertitle: 'Pipa Distribusi',
                interactive: true,
                title: '<img src="styles/legend/PipaDistribusi_14.png" /> Pipa Distribusi'
            });
...
var group_INFRASTRUKTURMIGASTAMBANGINDONESIA = new ol.layer.Group({
                                layers: [lyr_CadanganMigasperWilayah_9,lyr_WilayahKerjaMigas_10,lyr_WIUPTambang_11,lyr_TerminalGasLNG_12,lyr_TerminalCNG_13,lyr_PipaDistribusi_14,lyr_PipaTransmisiGasBumi_15,],
                                fold: "open",
                                title: 'INFRASTRUKTUR MIGAS & TAMBANG INDONESIA'});
var group_INFRASTRUKTURLISTRIKINDONESIA = new ol.layer.Group({
                                layers: [lyr_SebaranPembangkitListrik_6,lyr_PetaJaringanListrik_7,lyr_PetaSebaranLokasiGarduInduk_8,],
                                fold: "open",
                                title: 'INFRASTRUKTUR LISTRIK INDONESIA'});
var group_INFRASTRUKTURPELABUHANTERMINALINDONESIA = new ol.layer.Group({
                                layers: [lyr_SebaranPelabuhanUmum_4,lyr_SebaranTerminalKhusus_5,],
                                fold: "open",
                                title: 'INFRASTRUKTUR PELABUHAN & TERMINAL INDONESIA'});

lyr_GoogleTerrain_0.setVisible(false);lyr_GoogleRoad_1.setVisible(false);lyr_GoogleHybrid_2.setVisible(false);lyr_GoogleSatellite_3.setVisible(false);lyr_SebaranPelabuhanUmum_4.setVisible(false);lyr_SebaranTerminalKhusus_5.setVisible(false);lyr_SebaranPembangkitListrik_6.setVisible(false);lyr_PetaJaringanListrik_7.setVisible(false);lyr_PetaSebaranLokasiGarduInduk_8.setVisible(false);lyr_CadanganMigasperWilayah_9.setVisible(false);lyr_WilayahKerjaMigas_10.setVisible(false);lyr_WIUPTambang_11.setVisible(false);lyr_TerminalGasLNG_12.setVisible(false);lyr_TerminalCNG_13.setVisible(false);lyr_PipaDistribusi_14.setVisible(false);lyr_PipaTransmisiGasBumi_15.setVisible(false);lyr_TerminalGasPuloampel_16.setVisible(false);lyr_Smelter_17.setVisible(false);lyr_SHPKawasanIndustriKalla_18.setVisible(false);lyr_TitikLahan_19.setVisible(false);lyr_PembangkitListrik_20.setVisible(false);lyr_TitikPembangkitListrik_21.setVisible(false);lyr_JaringanListrik_22.setVisible(false);lyr_SHPTambang_23.setVisible(false);lyr_TitikTambang_24.setVisible(false);lyr_RuteTambang_25.setVisible(false);
var layersList = [lyr_GoogleTerrain_0,lyr_GoogleRoad_1,lyr_GoogleHybrid_2,lyr_GoogleSatellite_3,group_INFRASTRUKTURPELABUHANTERMINALINDONESIA,group_INFRASTRUKTURLISTRIKINDONESIA,group_INFRASTRUKTURMIGASTAMBANGINDONESIA,group_KALLATerminalGas,group_KALLASmelter,group_KALLAAsetKawasanIndustri,group_KALLAPembangkitListrik,group_KALLAPertambangan];
...
lyr_PipaDistribusi_14.set('fieldAliases', {'objectid_1': 'objectid_1', 'shape_leng': 'shape_leng', 'objectid': 'objectid', 'bu_name': 'bu_name', 'bu_initial': 'bu_initial', 'rn_initial': 'rn_initial', 'rn_name': 'rn_name', 'tipe_pipa': 'tipe_pipa', 'bph.bph_pp': 'bph.bph_pp', 'diameter': 'diameter', 'length': 'length', 'st_length(': 'st_length(', });
...
lyr_TerminalGasPuloampel_16.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'Kap_mmscfd': 'Kap_mmscfd', });
...
lyr_PipaDistribusi_14.set('fieldImages', {'objectid_1': 'TextEdit', 'shape_leng': 'TextEdit', 'objectid': 'TextEdit', 'bu_name': 'TextEdit', 'bu_initial': 'TextEdit', 'rn_initial': 'TextEdit', 'rn_name': 'TextEdit', 'tipe_pipa': 'TextEdit', 'bph.bph_pp': 'TextEdit', 'diameter': 'TextEdit', 'length': 'TextEdit', 'st_length(': 'TextEdit', });
...
lyr_TerminalGasPuloampel_16.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'Kap_mmscfd': '', });
...
lyr_PipaDistribusi_14.set('fieldLabels', {'objectid_1': 'hidden field', 'shape_leng': 'hidden field', 'objectid': 'hidden field', 'bu_name': 'header label - always visible', 'bu_initial': 'hidden field', 'rn_initial': 'hidden field', 'rn_name': 'header label - always visible', 'tipe_pipa': 'header label - always visible', 'bph.bph_pp': 'header label - always visible', 'diameter': 'header label - always visible', 'length': 'hidden field', 'st_length(': 'hidden field', });
...
lyr_TerminalGasPuloampel_16.set('fieldLabels', {'Name': 'header label - always visible', 'description': 'hidden field', 'timestamp': 'hidden field', 'begin': 'hidden field', 'end': 'hidden field', 'altitudeMode': 'hidden field', 'tessellate': 'hidden field', 'extrude': 'hidden field', 'visibility': 'hidden field', 'drawOrder': 'hidden field', 'icon': 'hidden field', 'Kap_mmscfd': 'hidden field', });
...
lyr_SHPKawasanIndustriKalla_18.set('fieldLabels', {'Name': 'header label - always visible', 'descriptio': 'no label', 'Luas_Ha': 'header label - always visible', });
